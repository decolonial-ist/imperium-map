...
class Map {
  ...
  async _basemap() {
    ...
    // Вторая строка - на языке народа, а не по-русски (куратор 09.09.2026):
    // сверху английское имя, снизу чеченское.
    const RENAMES = {
      'Чечня': ['Chechen Republic of Ichkeria', 'Noxçiyn Respublika Içkeriya'],
    };
