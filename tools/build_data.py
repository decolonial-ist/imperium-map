...
#    страны Балтии уже вне полигона). Более раннего честного контура у CShapes нет;
...
#    срез 1919 был его дубликатом, убран (в манифест не попадает; 22.09.2026
#    файл вместе с другими срезами вне манифеста перенесён в приватный репо,
#    deprecated/data/years).
