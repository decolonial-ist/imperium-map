...
# Казачья станица, переселенческое село и военный пост добавлены 17.09.2026:
# куратор расширил слой («Р3 вноси») - гражданское заселение отнятой земли
# тоже точка, а не только гарнизон.
