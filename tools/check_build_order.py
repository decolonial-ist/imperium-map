...
# красного в Хэйлунцзяне, Норрботтене и Расоне. Идёт после позднего окна и
# ДО 'ostrogs': точки считают «вокруг покраснело» по срезам, и на
# необрезанных срезах уходили с карты. После неё срезы пишет только 'ww1',
# а его срезы обрезка пропускает, как срезы ВМВ
# 'ww1' (19.09.2026) - помесячные срезы Первой мировой (tools/build_ww1.py).
# Основа - довоенный срез 1914-04-04 от первого шага; поздние правки окна
# 1914-1917 не касаются (все с 18.03.1921). С 21.09.2026 слой идёт ПОСЛЕ
# обрезки чужой земли: основа к нему приходит уже обрезанной, а занятое за
# границей (Галиция, Эрзерум) обрезка срезала бы. 19-21.09 он стоял до
# обрезки, двумя фичами, и обводка рисовала довоенную границу внутри красного
CANON = ['expansion', 'zones_1917_1921', 'pact_1939', 'ww2',
         'expansion-late', 'clip_foreign', 'ww1', 'losses', 'ostrogs', 'lite',
         'mid', 'start']
