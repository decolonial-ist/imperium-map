...
GROUPS = {
    # Чечня 1993-1994: районы, где на земле распоряжался промосковский
    # «Временный совет» Автурханова. Заявка домена Нохчи 08.09.2026 с
    # документами - NOTICE_OT_NOHCHI_CHECHNYA_1993-1994_KONTROL_2026-09-08.md;
    # решение куратора: красить как современную Беларусь, зоной влияния.
    'chechnya_opposition_1994': {
        'out': 'chechnya/opposition_1993_1994.geojson',
        'label': 'Надтеречный район (опора Временного совета)',
        'bbox': (43.2, 44.7, 44.0, 45.6),
        'names': ['Надтеречный район'],
    },
    # Второй оплот Временного совета. «Мемориал» 2010: после срыва референдума
    # 05.06.1993 вооружённые сторонники оппозиции «отступили в Надтеречный и
    # Урус-Мартановский районы Чечни», её «оплотами стали» оба района; Дунлоп
    # 1998: 25.08.1994 правительство России секретным постановлением признало
    # Временный совет единственной законной властью и стало платить зарплаты и
    # пенсии населению обоих районов.
    'chechnya_urus_martan_1994': {
        'out': 'chechnya/urus_martan_1994.geojson',
        'label': 'Урус-Мартановский район (второй оплот Временного совета)',
        'bbox': (42.7, 45.2, 43.3, 45.9),
        'names': ['Урус-Мартановский район'],
    },
